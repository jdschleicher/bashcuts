...
$script:AzDevOpsHelpCatalog = @(
    ...
    [PSCustomObject]@{
        ...
        Phase         = 'DailyRead'
        Order         = 1
        Purpose       = 'Pickable grid of work items assigned to you (from cache); select rows to pipe onward'
        Args          = '[-State <states>]'
        Example       = 'az-Get-AzDevOpsAssigned'
        RunsBefore    = 'az-Open-WorkItemById'
        RequiresSync  = 'Yes'
    ...
    [PSCustomObject]@{
        Name          = 'az-Show-Assigned'
        File          = 'powcuts_by_cli/azdevops_views.ps1'
        Phase         = 'DailyRead'
        Order         = 2
        Purpose       = 'Display-only grid of work items assigned to you (from cache); no row selection'
        Args          = '[-State <states>]'
        Example       = 'az-Show-Assigned'
    ...
    [PSCustomObject]@{
        ...
        Phase         = 'DailyRead'
        Order         = 3
        Purpose       = 'Open the "Assigned to me" web view in your browser (every item assigned to you)'
        Args          = '(none)'
